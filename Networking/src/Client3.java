...
public class Client3 implements Runnable{
		...
		try{
	        ...
	        while(!isStopped()){
	            ...
	            while(tempFileNum >= 0) {
	    			...
	    			System.out.println("request of " + tempFileNum + " is " + requestChunks[tempFileNum]);
	    			int currentRead = 0;
	    			...
	    			System.out.println("tempFileNum : " + tempFileNum);
	...
	public static void main(String args[]) throws UnknownHostException, IOException{
		Client3 peer = new Client3(peerID);
